...
import cc.ykai.tinychat.ui.main.ChatScreen
import cc.ykai.tinychat.ui.main.ChatViewModel
import cc.ykai.tinychat.ui.settings.SettingsScreen
import cc.ykai.tinychat.ui.settings.ModelPickerDialog
...
fun LlmChatApp(viewModel: ChatViewModel) {
  ...
  if (showSettings) {
    ...
    ChatScreen(
      ...
      onSelectMessageBranch = viewModel::selectMessageBranch,
